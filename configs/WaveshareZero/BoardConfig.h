...
#define BOARD_CONFIG_LABEL "GuudBox"
...
#define PIN_BUTTON_S1   28          // S1 / Back / Minus / Select / 9 / Coin
#define PIN_BUTTON_S2   29          // S2 / Start / Plus / Start / 10 / Start
#define PIN_BUTTON_L3   14          // L3 / LS / LS / L3 / 11 / LS
#define PIN_BUTTON_R3   15          // R3 / RS / RS / R3 / 12 / RS
#define PIN_BUTTON_A1   26          // A1 / Guide / Home / PS / 13 / ~
#define PIN_BUTTON_A2   27          // A2 / ~ / Capture / ~ / 14 / ~
#define PIN_BUTTON_FN   0           // Hotkey Function
